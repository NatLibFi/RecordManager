<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="lido">
            <doc>
				...
				<field name="title">
				<xsl:choose>
					<xsl:when test="//lido/descriptiveMetadata/objectIdentificationWrap/titleWrap/titleSet/appellationValue[@xml:lang='fi']">
						<xsl:value-of select="//lido/descriptiveMetadata/objectIdentificationWrap/titleWrap/titleSet/appellationValue[@xml:lang='fi']"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="//lido/descriptiveMetadata/objectIdentificationWrap/titleWrap/titleSet/appellationValue"/>
					</xsl:otherwise>
				</xsl:choose>
                </field>
