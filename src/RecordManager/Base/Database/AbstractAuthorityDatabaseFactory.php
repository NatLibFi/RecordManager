 ...
 * @link     https://github.com/NatLibFi/RecordManager
 */
class AbstractAuthorityDatabaseFactory implements \Laminas\ServiceManager\Factory\FactoryInterface
{
    /**
     * Create an object
     *
    ...
    public function __invoke(
        ...
        return new $dbClass($dbConfig[$backend]);
    }
}
